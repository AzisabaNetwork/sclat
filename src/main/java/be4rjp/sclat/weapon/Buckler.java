    ...
    public static void BucklerRunnable(Player player) {
        BukkitRunnable delay3 = new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (data.getIsSneaking() && bk_recharge && player.getGameMode().equals(GameMode.ADVENTURE) && p.getInventory().getItemInMainHand().getType().equals(data.getWeaponClass().getMainWeapon().getWeaponIteamStack().getType())) {
