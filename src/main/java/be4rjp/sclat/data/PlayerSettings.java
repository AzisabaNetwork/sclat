...
public class PlayerSettings {
    ...
    public boolean ShowEffect_MainWeaponInk() {
        return this.ShowEffect_MainWeaponInk;
    }

    public boolean ShowEffect_ChargerLine() {
        return this.ShowEffect_ChargerLine;
    }

    public boolean ShowEffect_SPWeapon() {
        return this.ShowEffect_SPWeapon;
    }

    public boolean ShowEffect_SPWeaponRegion() {
    ...
    public boolean ShowEffect_Squid() {
        return this.ShowEffect_Squid;
    }

    public boolean ShowEffect_BombEx() {
        return this.ShowEffect_BombEx;
    }

    public boolean ShowEffect_Bomb() {
